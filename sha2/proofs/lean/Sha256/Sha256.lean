...
/-- SHA-256 Impl-level spec — corollary of the IV-generic
`sha2_inner_spec` at `iv = consts.H256_256, iv_vec = Impl.H256_256`,
bridged back to `Impl.sha256` via `Local.sha256_eq_sha2Inner256`. -/
